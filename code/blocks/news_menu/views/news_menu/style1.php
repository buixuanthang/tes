<?php global $tmpl;
	$tmpl -> addStylesheet('style1','blocks/news_menu/assets/css');
?>
	<!--	CONTENT -->
    <div class="title_list_news"><img src="<?php echo URL_ROOT . '/images/config/logo_black.png';?>" alt="log_black">Danh mục tin tức</div>
