...
//        $this->pdo = new PDO('mysql:host='.$db_info['dbHost'].';dbname='.$db_info['dbName'].';charset=UTF-8', $db_info['dbUser'], $db_info['dbPass']); 
        $this->pdo = new PDO('mysql:host='.$db_info['dbHost'].';dbname='.$db_info['dbName'].';charset=UTF-8', $db_info['dbUser'], $db_info['dbPass'],array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8")); 
