 ...
 $(function() {				
					$("#previews").sortable({
						update : function () {
							...
							$.ajax({
								url: "index2.php?module=projects&view=projects&raw=1&task=sort_other_images",
								type: "post",
								data: serial,
								error: function(){
...
//					  parallelUploads: 100,
//					  maxFiles: 100,
				  url: "index2.php?module=projects&view=projects&raw=1&task=upload_other_images&data="+uploadConfig,
				  thumbnailWidth: 100,
				  thumbnailHeight: 100,
				  parallelUploads: 20,
				  ...
				  removedfile: function(file) {
					    ...
					    $.ajax({
					        type: "POST",
					        url: "index2.php?module=projects&view=projects&raw=1&task=delete_other_image",
