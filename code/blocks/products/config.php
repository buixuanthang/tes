...
//					'value' => array('default' => 'Mặc định','horizontal'=>'Hàng ngang','vertical'=>'Hàng dọc','vertical_img_large'=>'Hàng dọc ảnh lớn')
					'value' => array('default' => 'Mặc định (slideshow)','slideshow_hot'=>'Sản phẩm hot (có slideshow)','horizontal'=>'Hàng ngang','vertical'=>'Hàng dọc','vertical_img_large'=>'Hàng dọc ảnh lớn')
			)
	);
?>