...
?>
	...
	<div class='news_list_body_column cls block_body'>
			<?php 
			$Itemid = 4;
          ...
          <div class='news-item-inner cls'> 
              <figure>
                <a href='<?php echo $link;?>' title="<?php echo $item->title;?>">
              	...
              	<div class="title"><a href='<?php echo $link;?>' title="<?php echo $item->title;?>" class="_text_2_hover"><?php echo get_word_by_length(50,$item->title);?></a> </div>	
              	<div class="date">
              		<?php echo fsdate($item -> created_time,2); ?>
              	</div>
                <div class="summary"><?php echo get_word_by_length(100,$item->summary);?></div>
                <div class='clear'></div>
          </div>
         </div>   
			<?php }	?>
