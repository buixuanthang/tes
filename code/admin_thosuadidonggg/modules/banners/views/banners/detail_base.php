<?php 
 ...
 ?>		
	<div class="form-group">
        <label class="col-sm-2 col-xs-12 control-label"><?php echo FSText::_('Loại banner'); ?></label>
...
?>    
<div class="form-group">
    <label class="col-sm-2 col-xs-12 control-label"><?php echo  FSText::_('Flash'); ?></label>
	<div class="col-sm-6 col-xs-12">
		<?php if(@$data->flash){?>
...
<?php TemplateHelper::dt_edit_text(FSText :: _('Nội dung (Nếu bạn chọn loại banner là HTML)'),'content_html',@$data -> type == 3 ? $data -> content:'','',650,450,1,'','','col-sm-2','col-sm-10');  ?>    
<?php TemplateHelper::dt_edit_text(FSText :: _('Nội dung (Nếu bạn chọn loại banner là TEXT)'),'content_txt',@$data -> type == 4 ? $data -> content:'','',70,10,0,'','','col-sm-2','col-sm-10');  ?>    
	...
	<div class="form-group">
		...
		<div class="col-sm-6 col-xs-12">
			...
			?>
			<select data-placeholder="<?php echo FSText::_('Nơi xuất hiện') ?>" name ="menus_items[]" size="8" multiple="multiple" class='form-control  listItem' <?php echo (!@$data->listItemid || @$data->listItemid == 'none' || @$data->listItemid == 'all')? 'disabled="disabled"':'';?> >
				<?php 
...
<?php 
//    TemplateHelper::dt_edit_selectbox(FSText::_('Danh mục tin tức'),'news_categories',@$data->id,0,$news_categories,$field_value = 'id', $field_label='treename',$size = 1,1);
//    TemplateHelper::dt_edit_selectbox(FSText::_('Danh mục sản phẩm'),'products_categories',@$data->id,0,$products_categories,$field_value = 'id', $field_label='treename',$size = 1,1);
//    TemplateHelper::dt_edit_selectbox(FSText::_('Danh mục trang tĩnh'),'contents_categories',@$data->id,0,$contents_categories,$field_value = 'id', $field_label='treename',$size = 1,1);
