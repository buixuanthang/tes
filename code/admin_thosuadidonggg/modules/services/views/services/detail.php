...
TemplateHelper::dt_edit_text(FSText :: _('Summary'),'summary',@$data -> summary,'',120,9);
TemplateHelper::dt_edit_text(FSText :: _('Content'),'content',@$data -> content,'',650,450,1);
TemplateHelper::dt_edit_text(FSText :: _('Điểm mạnh'),'strength',@$data -> strength,'',650,450,1);
