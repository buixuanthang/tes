...
<?php 
global $tmpl,$config; 
$tmpl -> addStylesheet('thosuadidong','blocks/mainmenu/assets/css');
$tmpl -> addScript('thosuadidong','blocks/mainmenu/assets/js');
...
<ul>
  <li class='<?php echo $Itemid == 1? 'activated':''; ?>' ><a href='<?php echo URL_ROOT; ?>' ><span> Trang chủ</span></a>  </li>
  <?php
  $html = ""; 
  $i = 1;
  $num_child = array();
