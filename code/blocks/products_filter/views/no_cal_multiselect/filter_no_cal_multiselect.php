...
//		}
		...
		$html_filter .= '</div><div id="'.$filters[0] -> field_name.'"  class="field_label filters_in_field scroll_bar filter_4_'.$filters[0] -> field_name.'" '.($closed?' style="display:none"':'' ). '  >';
...
?>
<div class='block_product_filter filter_no_cal_multiselect'>
