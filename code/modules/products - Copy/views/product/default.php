...
<div class='product cls' id="product_page" itemscope="" itemtype="https://schema.org/Product">
	...
	<div class='frame_right'>
		...
		<?php  $tmpl -> load_direct_blocks('strengths', array('style'=>'style2_thosuadidong','catid'=>2,'limit'=>6));?>	
		
		<?php if($tmpl->count_block('right-news')) {?>
     
        	<?php  echo $tmpl -> load_position('right-news', 'XHTML'); ?>
