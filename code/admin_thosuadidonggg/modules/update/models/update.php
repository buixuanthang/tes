...
//				$this -> _update($row3, 'fs_products_images',' `id` = '.$item->id);
		...
		*/
		function exec_image_on_local($link_img){
			$folder_image_begin = 'F:\project\daikin_v1_online\\';
			$folder_image_destination = 'F:\project\daikinv2\code\\';
			$fsFile = FSFactory::getClass('FsFiles','');
			...
			$arr_img_paths = array (array ('resized', 256, 210, 'resize_image' ), array ('small', 86, 70, 'cut_image' ), array ('large', 512, 420, 'resize_image' ) );
