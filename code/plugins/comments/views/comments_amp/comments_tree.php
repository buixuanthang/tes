...
//				$html .= '<a class="button_reply" href="'.$link_r.'" >Trả lời</a>';
...
//				$html .= '<a class="favorite" href="javascript: void(0)" >Thích</a>';
			...
			$html .= '<div class="reply_area hide">';
				$html .= '<form action="#" method="get" name="comment_reply_form_'.$item -> id.'"  id="comment_reply_form_'.$item -> id.'"  class="form_comment cls" target="_top" >';
...
//							$html .= '</aside>';
							...
							$html .= '<aside class="_right"> ';               
								$html .= '<input class="txt_input" name="name"  id="cmt_name_'.$item -> id.'" type="text" placeholder="Họ tên (bắt buộc)" maxlength="50" autocomplete="off" value="'.@$_COOKIE['full_name'].'">';
...
?>
	...
	<?php if($pagination){ ?>
	<div class='readmore'><a href="<?php echo $link_r; ?>" title="Xem thêm">Xem thêm</a></div>
	<?php } ?>
<?php }?>
