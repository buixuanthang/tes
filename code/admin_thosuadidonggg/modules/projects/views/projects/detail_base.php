<table cellspacing="1" class="admintable">
	...
	TemplateHelper::dt_edit_selectbox(FSText::_('Tiến độ'),'type',@$data -> type,0,$arr_types,$field_value = 'id', $field_label='name',$size = 10,0,1);
	TemplateHelper::dt_edit_text(FSText :: _('Summary'),'summary',@$data -> summary,'',100,9);
	TemplateHelper::dt_edit_text(FSText :: _('Địa điểm'),'location',@$data -> location);
