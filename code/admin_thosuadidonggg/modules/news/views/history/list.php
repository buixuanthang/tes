...
//	$fitler_config['filter'][] = $filter_categories;																																																																																			
	...
	$list_config[] = array('title'=>'Tiêu đề','field'=>'title','ordering'=> 1, 'type'=>'text','col_width' => '20%');
...
//	$list_config[] = array('title'=>'Id','field'=>'id','ordering'=> 1, 'type'=>'text');
	...
	TemplateHelper::genarate_form_liting($this->module,$this -> view,$list,null,$list_config,$sort_field,$sort_direct);
?>
