...
//			}
			...
			else
			{
				$sql = " INSERT INTO ".$this -> table_name."
							(name,alias,".$sql_insert_img_field."link,".$sql_insert_parent_id_field."group_id,published,ordering,target,show_admin,".$sql_insert_default_field."updated_time,created_time)
							VALUES ('$name','$alias',".$sql_insert_img_value."'$link',".$sql_insert_parent_id_value."'$group_id','$published','$ordering','$target','$show_admin',".$sql_insert_default_value."'$time','$time')
							";
				//print_r($sql);die;			
				$id = $db->insert($sql);
				if(!$id)
